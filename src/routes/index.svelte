<div class="grid-bg ba-grid anim">
  <div class="inner " />
  <div
    class=" w-full h-screen flex flex-col justify-center items-center relative z-90"
  >
    <h1 class=" text-center">
      <span style="font-family: 'Rancho', cursive;" class=" text-white text-5xl"
        >Starzdev</span
      >
      ⭐
      <p style="font-family: 'Rancho', cursive;" class=" text-sm sm:text-base text-white">
        It’s not a bug. It’s an undocumented feature!
      </p>
    </h1>
    <div class=" mt-3">
      <a href="https://github.com/Starz-dev">
        <button class="btn mx-2">About</button>
      </a>
      <a href="mailto:query@starzdev.com" target="_blank">
        <button class="btn mx-2"> Contact </button></a
      >
    </div>
  </div>
</div>
...
<style>
  ...
  .btn {
    @apply text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2;
  }
